...
export type GetStakingRewardQuery = {
  __typename?: 'Query';
  staker?: {
    __typename?: 'Staker';
    stakes: Array<{ __typename?: 'Stake'; rewards: any }>;
  } | null;
};
...
>;
export const GetStakingRewardDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetStakingReward' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
