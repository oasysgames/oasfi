...
export type GetEpochRewardsByAddressQueryVariables = Exact<{
  epoch: Scalars['BigInt'];
  address: Scalars['Bytes'];
}>;


export type GetEpochRewardsByAddressQuery = { __typename?: 'Query', epochRewards: Array<{ __typename?: 'EpochReward', epoch: any, address: any, commissions: any, rewards: any }> };
...
export type GetStakerRewardQuery = { __typename?: 'Query', staker?: { __typename?: 'Staker', stakes: Array<{ __typename?: 'Stake', rewards: any, validator: { __typename?: 'Validator', id: string } }> } | null };

export type GetStakerStakeQueryVariables = Exact<{
  staker: Scalars['ID'];
  block: Scalars['Int'];
}>;


export type GetStakerStakeQuery = { __typename?: 'Query', staker?: { __typename?: 'Staker', stakes: Array<{ __typename?: 'Stake', oas: any, soas: any, woas: any }> } | null };
...
export const GetEpochRewardsByAddressDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetEpochRewardsByAddress"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"epoch"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BigInt"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"address"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Bytes"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"epochRewards"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"epoch"},"value":{"kind":"Variable","name":{"kind":"Name","value":"epoch"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"address"},"value":{"kind":"Variable","name":{"kind":"Name","value":"address"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"epoch"}},{"kind":"Field","name":{"kind":"Name","value":"address"}},{"kind":"Field","name":{"kind":"Name","value":"commissions"}},{"kind":"Field","name":{"kind":"Name","value":"rewards"}}]}}]}}]} as unknown as DocumentNode<GetEpochRewardsByAddressQuery, GetEpochRewardsByAddressQueryVariables>;
